 ...
 */
@interface _FAEDownloadEngine : NSObject {}
...
typedef NS_ENUM(NSUInteger, FAEDownloadFailureCode)
{
    ...
    /** The already downloaded audio does not match what the current audio from the api would be. Audio should be deleted in order to continue */
    FAEDownloadFailureCodeMismatchAudio = 11011,
